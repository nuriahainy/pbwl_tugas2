...
<head>
    ...
    <title>Tugas 2 - Nurcahaya Harahap</title>
</head>
...
<body>
    <div class="template-nuriah">
        ...
        <div class="content">
            <nav class="top-bar">
                <div>Tugas PWD | Nurcahaya Harahap - 0702193158</div>
            </nav>
            ...
            <footer>
                <div class="container">
                    &copy; Copyright Nurcahaya Harahap | Tugas 2 PWD
                </div>
            </footer>
        </div>
    </div>
